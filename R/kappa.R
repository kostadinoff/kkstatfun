...
#' Cohen's Kappa Agreement Test
#'
#' @description Computes Cohen's Kappa coefficient (\eqn{\kappa}) to evaluate the agreement
...
#'     \item \code{kappa}: Cohen's Kappa coefficient (\eqn{\kappa}).
#'     \item \code{std_error}: The standard error (\eqn{\sigma_\kappa}).
