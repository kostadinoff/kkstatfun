...
#> 1 Cochran-Armitage Trend      3.21 NA    NA    0.00135       0.95        4     200
#> 2 Trend OR (per unit)         1.68  1.21  2.32 0.00179       0.95        4     200
```
...
#> 2 z     univariate         1.58    0.385       6.51     0.722     0.636   0.525       0.95
#> 3 x     multivariable      2.80    0.735      10.6      0.682     1.51    0.132       0.95
#> 4 z     multivariable      0.605   0.0697      5.25     1.10     -0.456   0.648       0.95
```
...
#>   <chr> <dbl> <dbl>  <dbl> <chr>
#> 1 A      45.2 0.626 0.0637 1    
#> 2 B      41.0 0.438 0.0653 1
```
